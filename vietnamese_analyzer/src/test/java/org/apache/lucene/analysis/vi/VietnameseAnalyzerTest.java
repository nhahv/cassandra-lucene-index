...
public class VietnameseAnalyzerTest extends BaseTokenStreamTestCase {
    @Test
    public void analyzeVietnamese() throws IOException {
    ...
    @Test
    public void analyzeVietnamese2() throws IOException {
        VietnameseAnalyzer analyzer = new VietnameseAnalyzer();
    ...
    @Test
    public void analyzeVietnamese3() throws IOException {
        VietnameseAnalyzer analyzer = new VietnameseAnalyzer();
    ...
    @Test
    public void tokenOffset() throws IOException {
        VietnameseAnalyzer analyzer = new VietnameseAnalyzer();
